 ...
 * @param favoritePokemonList Lista de Pokemon a mostrar, cada uno representado por un [DrawableStringPair]
...
fun FavoritePokemonGrid(
    favoritePokemonList: List<Pokemon>,
    onPokemonClick: () -> Unit
) {
    LazyHorizontalGrid(
        ...
        items(favoritePokemonList) { pokemon ->
            PokemonCard(
                name = pokemon.name,
